...
var strDest = 'WeatherReport - Test Execution Result ' + totalDateString;

var reporter = new HtmlScreenshotReporter({
	dest: strDest,
	filename: 'WeatherReport - Test Execution Result.html',
	reportTitle: 'WeatherReport - Test Execution Result',
...
var reporterJUnit = new jasmineReporters.JUnitXmlReporter({
	...
	modifyReportFileName: function(generatedFileName, suite) {
		return 'WeatherReport - Test Execution Result.xml';
	},
	consolidateAll: true
});
...
exports.config = {
	...
	specs: [ 
        'TS01-LabelVerification.js',
        'TS02-InvalidCitySelection.js',
        'TS03-ValidCitySelection.js'
	],
